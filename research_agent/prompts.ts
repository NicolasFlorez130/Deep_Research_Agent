export const researchAgentPrompt = (date: string) => `
...
export const summarizeWebpagePrompt = (webpage_content: string, date: string) => `
...
export const compressResearchPrompt = (date: string) => `
...
export const compressResearchHumanMessage = (researchTopic: string) => `
